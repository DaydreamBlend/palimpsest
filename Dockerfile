...
COPY tools/container_init.py tools/run_app_tests.py tools/check_storage_sql.py tools/run_d2i.py tools/run_pdf_evidence.py tools/run_d2k_pdf.py tools/run_propagation.py tools/desktop_bridge.py tools/realm_bridge.py tools/prepare_n2e_semantic_batches.py tools/run_knowledge_batches.py ./tools/
