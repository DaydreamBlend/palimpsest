...
- `docker compose -p palimpsest-t03-image-verify run --rm --no-deps -T test`: **307 tests/28.413초/failure0/error0/skip16/exit0**. [로그](../output/t23-ui-realm/build-test-logs.zip#output/t03-image-default/runtime/app-tests.log). 별도 pinned MinerU image에서 `python -B -m unittest -v test_pdf_raster test_pdf_text_evidence test_pdf_visual_evidence`: **22 tests/0.728초/failure0/error0/skip0/exit0**. [로그](../output/t23-ui-realm/build-test-logs.zip#output/t03-image-default/runtime/native-tests.log).
