...
> 문서 상태: Current canonical architecture and terminology — CLI-first / MinerU / plain-English components / BGE-M3 defaults / modular stages / K2W / scoped architecture repairs revision 2026-09-09
>
> 적용 변경: U01(CLI 우선·GUI 마지막), U02(PDF parser=MinerU), U03(영어 구성요소 명칭), U04(BGE-M3 검색 모델 기본값), U05(MinerU 최신 안정판 정책), U06(domain·변환별 모듈화), U07(K2W 명칭 간소화), U08(검토 R01–R09 해결; R07/R08 후속 사용자 승인 포함). 나머지 P01–P12 보완안은 별도 승인 전까지 제안 상태다.
>
> 언어: 한국어
>
